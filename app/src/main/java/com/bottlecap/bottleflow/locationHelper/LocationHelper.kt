...
import com.bottlecap.bottleflow.BottleApp
import com.bottlecap.bottleflow.R
...
class LocationHelper {
    ...
    fun requestLocation(activityContext: Activity, listener: ILocationReadyListener): Boolean {
